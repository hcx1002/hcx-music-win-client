<template>
  <div class="flex player-song">
    <img alt="" class="w-11 h-11 rounded cursor-pointer" :src="song.al?.picUrl || OpticalDisk" @click="id!==0?showPlayView=true:showPlayView=false"/>
    <div class="ml-2 text-xs flex flex-col justify-between">
      <div class="w-52 2xl:w-96 truncate">
        <div class="flex">
...
const {song, songUrl,showPlayView,id} = toRefs(usePlayerStore())
</script>
